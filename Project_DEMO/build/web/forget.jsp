<%-- 
    Document   : forget
    Created on : Jul 11, 2022, 1:30:40 PM
    Author     : admin
--%>
        ...
        <div class="login-div">
            <div class="container">
                ...
                <div class="login-box">
                    ...
                    <form action="forget" class="login-form text-left" method="post">
                        <div>
                        ...
                        <div>
                            <input required type="password" name="pass1" placeholder="Nhập mật khẩu mới"/>
                        </div>
                        <div>
                            <input required type="password" name="pass2" placeholder="Nhập lại mật khẩu mới"/>
                        </div>
                        <div>
