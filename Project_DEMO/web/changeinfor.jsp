<%-- 
    ...
    Created on : Jul 12, 2022, 8:23:47 AM
    Author     : admin
--%>
        ...
        <div class="acc-infor">
            <div class="container">
                ...
                <div class="action-box">
                    ...
                    <form action="changeinfor" class="login-form text-left" method="post">
                        <%
                  if(request.getAttribute("error")!=null){
                    String er= (String)request.getAttribute("error");
                        ...
                        <div>
                            ...
                            <input required type="text" name="fname" value="${u.fname}"/>
                        </div>
                        <div>
                            <p style="font-weight: 600;">Họ:</p>
                            <input required type="text" name="lname" value="${u.lname}"/>
                        </div>
                        <div>
                            <p style="font-weight: 600;">Mật khẩu:</p>
                            <input required type="password" name="password" value="${u.password}"/>
                        </div>
                        <div>
